...
if __name__ == '__main__':
    ...
    parse.add_argument('--head_path', default='include/vector.h', type=str, help='path for the head file')
    parse.add_argument('--libclang_path', default='libclang.dylib', type=str, help='path for the head file')
